...
public void tb_load(){
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(33, 33, 33)
                        .addComponent(txt_Cus_Name, javax.swing.GroupLayout.PREFERRED_SIZE, 199, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addContainerGap()
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(txt_Cus_TP, javax.swing.GroupLayout.PREFERRED_SIZE, 199, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void btn_SaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_SaveActionPerformed
        ...
        try {
            ...
            Statement s = db.mycon().createStatement();
            s.executeUpdate("INSERT INTO employee (employee_name,TP_Number) VALUES('"+name+"','"+cus_tp+"') ");
    ...
    private void btn_searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_searchActionPerformed
        ...
        String id = txt_SearchID.getText();
         ...
         if (!InputValidator.validateNotNullOrEmpty(id)) {
        ...
        try{
            ...
            //customer_name
            if (rs.next()){
                txt_Cus_Name.setText(rs.getString("employee_name"));
    ...
    private void btn_UpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_UpdateActionPerformed
        ...
        if (!InputValidator.validateNotNullOrEmpty(tp)) {
        JOptionPane.showMessageDialog(null, "Field not be null.");
        return;
        }
        ...
        // Validate phone number - 10 digits only
        if (!InputValidator.validatePhoneNumber(tp)) {
        JOptionPane.showMessageDialog(null, "Please enter a valid phone number.");
        return;
        } 
